...
export const seriesMetadata: Record<string, SeriesMetadata> = {
  ...
  'A Court of Thorns and Roses': {
    author: 'Sarah J. Maas',
    genre: 'Fantasy',
    blurb: 'A Court of Thorns and Roses is Sarah J. Maas\'s wildly popular romantasy series that begins as a loose retelling of Beauty and the Beast before expanding into a high-stakes epic of faerie politics and war. Feyre Archeron, a mortal huntress who kills a wolf in the woods, is taken captive to the magical realm of Prythian by Tamlin, a High Fae who demands a life for a life under a mysterious treaty. The series follows Feyre\'s evolution from a desperate human girl into a powerful player in the intricate power struggles between the seven Courts of Prythian — each ruled by a formidable High Lord with their own centuries-old agendas. Feyre navigates dangerous trials, ancient curses, and the seductive, lethal charm of the Night Court\'s ruler, Rhysand, while discovering her own unexpected role in saving both faerie and human lands from destruction. These recaps are the perfect way to track the shifting allegiances, the deep histories of the High Lords, and the world-shaking revelations that define the ever-expanding ACOTAR universe.',
  },
  'The Inheritance Cycle': {
    author: 'Christopher Paolini',
    genre: 'Fantasy',
    blurb: 'The Inheritance Cycle is Christopher Paolini\'s beloved high-fantasy epic set in the land of Alagaésia, beginning with a farmboy named Eragon who discovers a polished blue stone that hatches into the dragon Saphira. Thrust into a world of magic and ancient power, Eragon becomes the first new Dragon Rider in generations, tasked with overthrowing the tyrannical King Galbatorix who betrayed his own order centuries ago. The series follows Eragon and Saphira\'s journey across vast landscapes, from the dwarf-tunnels of Farthen Dûr to the elven forest of Du Weldenvarden, as they master the arts of swordplay and the ancient language of magic. Along the way, they forge alliances with elves, dwarves, and the Varden rebels while uncovering the deep history of the Riders and the source of the king\'s seemingly limitless power. Paolini\'s saga is a classic coming-of-age story that expands into a monumental war for the freedom of Alagaésia, making these recaps essential before returning to its rich lore and epic scope.',
  },
  'Mistborn: Era One': {
    author: 'Brandon Sanderson',
    genre: 'Fantasy',
    blurb: 'Mistborn: Era One is Brandon Sanderson\'s acclaimed heist-fantasy trilogy set in the ash-covered Final Empire, where the immortal Lord Ruler has maintained an iron-fisted, thousand-year reign. The series follows a charismatic thief named Kelsier and his street-urchin protégé, Vin, as they assemble a crew to pull off the ultimate con: overthrowing the god-emperor and inciting a rebellion among the oppressed skaa. Sanderson introduces Allomancy, a brilliantly engineered, hard-magic system where "Mistborn" burn ingested metals to enhance their physical and mental abilities. What begins as a relatively contained caper rapidly escalates into an epic struggle involving political intrigue, monstrous koloss armies, and cosmic entities of Preservation and Ruin. The series is celebrated for its meticulously plotted twists and deeply satisfying conclusions, making these recaps essential for readers looking to refresh their memory of Scadrial\'s foundational era.',
  },
  'Mistborn: Era Two': {
    author: 'Brandon Sanderson',
    genre: 'Fantasy',
    blurb: 'Mistborn: Era Two (The Wax and Wayne Series) is Brandon Sanderson’s high-octane evolution of the Mistborn world, shifting the setting three hundred years forward into a burgeoning industrial age of steam, steel, and six-shooters. The series follows Waxillium Ladrian, a lawman from the lawless Roughs who returns to the metropolis of Elendel to lead his noble house, only to find himself pulled back into a life of mystery and justice alongside his eccentric, fast-talking partner Wayne. Sanderson masterfully blends Western-inspired gunplay with the established Allomantic and Feruchemical magic systems, exploring how technology and Twinborn abilities interact in a rapidly modernizing society. Across four books—The Alloy of Law, Shadows of Self, The Bands of Mourning, and The Lost Metal—the stakes escalate from street-level investigations to a planetary-scale conflict involving the god Harmony and encroaching cosmic threats. These recaps are the perfect tool for tracking the dense political maneuvers, the evolving technology of the Basin, and the deep Cosmere connections that define this pivotal era of Scadrial.',
  },
};
